...
\title{Sub-Planck Structure is the Intersection of Elliptical Quanta Circumscribed by the Classical Action}
...
\begin{abstract}
Sub-Planck structure is not below the quantum of action. A state of
classical action $A$ circumscribes a family of elliptical quanta,
de~Gosson's blobs of area $h/2$. Their union is $A$. Their intersection
is $a = (h/2)^2/A$, the scale Zurek located to order of magnitude. It
lies inside every quantum of the state. No single Gaussian smoothing
that keeps the Wigner function non-negative resolves $a$ in every
direction. Smoothing over the whole family does, at amplitude $(h/2)/A$.
Sixteen states show this numerically.
\end{abstract}
