...
\title{Sub-Planck Structure Is the Intersection of a State's Elliptical Quanta}

\begin{abstract}
Zurek's sub-Planck scale $a \sim \hbar^2/A$ sets the finest phase-space structure of a state of classical action $A$. It has been read as lying below the quantum of action. We show it lies inside every quantum of the state. Its covariance ellipse, of area $A \ge h/2$, circumscribes a family of centered elliptical quanta of area $h/2$. Their union is $A$. Their intersection is exactly $a = (h/2)^2/A$. Smoothing with one quantum renders the Wigner function non-negative but singles out one quadrature. The family is coordinate-free, and smoothing over it resolves $a$ with nothing set from outside the state. Sixteen states confirm this numerically.
\end{abstract}
